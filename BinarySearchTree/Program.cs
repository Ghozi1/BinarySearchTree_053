...
namespace BinarySearchTree
{
    ...
    /* A Node Class consight of three things, the information, 
    ...
    class Program
    {
        ...
        {
            /*This Function search the currentNode of the specified Node as well as the currentNode of its parent */
            currentNode = ROOT;
            parent = null;
        ...
        public void postorder(Node ptr) /*Perfoms the postorder traversal of the three */
        {
            if (ROOT == null)
            {
                Console.WriteLine("Tree is empty");
